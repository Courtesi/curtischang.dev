  ...
  return (
    <div className="max-w-4xl px-[10%] pt-30 pb-24">
      ...
      <div className="mt-20 space-y-8 font-[Urbanist] text-xl text-blue-950/80 leading-relaxed">
        <p>
          I'm currently California-based, working on my startup <a href="https://trueshotodds.com" target="_blank" rel="noopener noreferrer" className="link-highlight text-stone-900 font-medium">TrueShotOdds</a>,
			a platform that helps bettors find profitable bets across prediction markets and sportsbooks.
			I'm documenting my journey as a founder through <a href="https://www.youtube.com/@TrueShotOdds" target="_blank" rel="noopener noreferrer" className="link-highlight text-stone-900 font-medium">YouTube</a>,
        ...
        <p>
          ...
          UC Irvine with a B.S. in Computer Science and also hold a CompTIA Security+ certification.
			...
			otherwise have to pay a subscription for (my <a href="#/reading-list" className="link-highlight text-stone-900 font-medium">collection</a> of reading materials).
        </p>
        <p>
